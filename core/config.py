...
_C.SCHRODINGER = CfgNode()

_C.SCHRODINGER.THRESHOLD = 0.01

_C.SCHRODINGER.ALPHA = 1.0 #1.0 10.0
_C.SCHRODINGER.BETA = 1.0 #1.0 10.0
_C.SCHRODINGER.GAMMA = 1.0 #1.0 10.0
_C.SCHRODINGER.DELTA=0.1
_C.SCHRODINGER.EPSILON=0.0005

_C.SCHRODINGER.H=1.0
_C.SCHRODINGER.M=1.0
_C.SCHRODINGER.E=1.0
_C.SCHRODINGER.V0=1.0

_C.SCHRODINGER.TRAIN_SCHRODINGERHEAd_EPOCHS=1000
_C.SCHRODINGER.HEAD_LR=0.001
_C.SCHRODINGER.SAVE_HEAD_DIR="./save/cifar10/schrodinger_head/"

_C.SCHRODINGER.BOUNDARY_LEFT=-20.0
_C.SCHRODINGER.BOUNDARY_RIGHT=0.0

_C.SCHRODINGER.LOAD_HEAD_DIR='./save/cifar10/schrodinger_head/cifar/schrodingerHead_900.pth'
_C.SCHRODINGER.ADA_HEAD_DURING_TEST=False

_C.SCHRODINGER.IND_THRESHOLD=0.9

_C.SCHRODINGER.USE_SCHRODINGERHEAd_LOSS=True

_C.SCHRODINGER.ZETA=1.0
